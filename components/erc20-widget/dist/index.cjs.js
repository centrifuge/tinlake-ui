...
var Circleinfo = styled__default.svg(_templateObject$1());
...
var Erc20Widget = function Erc20Widget(_ref) {
  ...
  return /*#__PURE__*/React__default.createElement(AxisTheme, {
  ...
  }, fieldLabel), /*#__PURE__*/React__default.createElement(Circleinfo, {
    onClick: function onClick() {
    ...
    direction: "row"
  }, /*#__PURE__*/React__default.createElement(grommet.Anchor, {
    href: "https://etherscan.io/token/" + (selectedToken === null || selectedToken === void 0 ? void 0 : selectedToken.address),
    label: "View Token"
  }), "\xA0on Etherscan")))), /*#__PURE__*/React__default.createElement(grommet.Box, {
    direction: "row-responsive",
    gap: "xxsmall",
    justify: "between",
    fill: "horizontal"
  }, !value && /*#__PURE__*/React__default.createElement(grommet.Box, {
    direction: "row",
    style: {
    ...
    truncate: true,
    id: "tokenValue"
  }, precision ? new BigNumber(value).toFormat(precision) + (ellipsis == true ? '…' : '') : new BigNumber(value).toFormat())), tokens.length == 1 && /*#__PURE__*/React__default.createElement(grommet.Box, {
    fill: "horizontal",
    direction: "row",
    gap: "small",
    align: "center",
