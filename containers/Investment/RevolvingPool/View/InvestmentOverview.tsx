        ...
        <Box width="420px" pad="medium" elevation="small" round="xsmall" margin={{ bottom: 'medium' }}>
          ...
          <Table margin={{ top: 'medium' }}>
            <TableBody>
              <TableRow>
                <TableCell scope="row">
                  <span>Avg Financing Fee</span>
                </TableCell>
                <TableCell style={{ textAlign: 'end' }}>
                  <LoadingValue done={dropRate !== undefined}>11.00 %</LoadingValue>
                </TableCell>
              </TableRow>
              <TableRow>
                <TableCell scope="row">
              ...
              <TableRow>
                ...
                <TableCell style={{ float: 'right' }} border={{ color: 'transparent' }}>
                  <Tooltip
                    title="TIN return"
                    description="The Junior Tranche does not have a pre-defined fixed or variable interest rate. TIN tokens capture the increasing value of the portfolio and the spread between Financing rates and DROP APRs."
                  >
                    <TextWithTooltip>Variable</TextWithTooltip>
                  </Tooltip>
                </TableCell>
              </TableRow>
            </TableBody>
